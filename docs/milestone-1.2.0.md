...
Next session entry point: obtain commit/add authority for M5 phase 10 step 16, then commit the retention checkpoint on `master`.
...
| 10 | 16 | Record the observed retention result and any separately owner-executed deletion result in a canonical checkpoint commit. | Separate canonical-update and commit/add authority | Retention evidence precedes next-line creation. | Ready for commit; the observed two-back branch result is recorded as N/A without deletion. |
