...
**Next session entry point:** M1 (#4, U3). Work order M1-M4 + M5 gate, set
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| M1 | 1.1.0 | #4 U3 UDS path containing ':' misrouted to TCP | Coherence + bug | Open | con.cpp:805-806 (client), 588-595 (auto-detect comment vs code); disambiguate UDS path vs host:port. bug, P1, area/uds. |
| M1.T1 | 1.1.0 | -c to a colon-bearing path connects as UDS, not TCP | Test sub | Open | — |
| M1.T2 | 1.1.0 | UDS client suite green (connect/echo/exit/readonly/peer-disconnect) | Test sub | Open | — |
...
**Tally:** milestones Open 5 (4 work + 1 gate) · test subs Open 9 · Done 0
